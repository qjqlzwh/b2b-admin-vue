...
<!--            <i slot="suffix" class="el-input__icon el-icon-circle-close" @click="pobj.customer=''; pobj.customerName=''" @click.stop></i>-->
        ...
        <div class="me-inner-title">
          <p>
            <span>添加商品</span>
            <el-button type="primary" round size="mini" icon="el-icon-plus" @click.native.prevent="addRow(pobj.orderItemList)">添加</el-button>
          </p>
        </div>
...
import { save, update } from '@/api/order/order'
