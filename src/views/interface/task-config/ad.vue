  ...
  <div class="me-form-container">
    <el-card class="box-card" shadow="hover">
      ...
      <el-form :model="pobj" :rules="rules" :inline="true" ref="pobj" label-width="100px" size="small">
        <el-form-item label="接口名称" prop="dname">
          <el-input v-model="pobj.dname" clearable></el-input>
        </el-form-item>
        <el-form-item label="接口类型" prop="type">
          <el-input-number v-model="pobj.type" :min="1" :max="9999" label="接口类型"></el-input-number>
        </el-form-item>
        <el-form-item label="创建时间">
          <el-input v-model="pobj.createTime" clearable disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="接口地址">
          <el-input v-model="pobj.url" clearable style="min-width: 727px;"></el-input>
        </el-form-item>
        <br/>
        <el-form-item class="me-form-memo" label="备注">
...
import { save, update, detail } from '@/api/interface/task-config'
