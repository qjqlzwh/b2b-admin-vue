<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column fixed label="机构名称" width="180" align="left">
        <template slot-scope="scope">
          {{ scope.row.dname }}
        </template>
      </el-table-column>
      <el-table-column label="机构编码" width="250" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.dcode }}</span>
        </template>
      </el-table-column>
      <el-table-column class-name="status-col" label="是否启用" width="80" align="center">
        <template slot-scope="scope">
